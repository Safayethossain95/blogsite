...
const TeamsDashPage = () => {
  ...
  const handledelete = async (myid) => {
    try {
      const response = await axios.delete(`${backendApi}/teamsdelete/${myid}`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`${backendApi}/teamspost`, formData);
      setFormData({
        name: "",
        title: "",
        description: "",
  ...
  return (
    <>
      ...
      <div className="content_ad">
        <h3 className="text-2xl font-serif text-center mb-[50px]">Teams Edit</h3>
